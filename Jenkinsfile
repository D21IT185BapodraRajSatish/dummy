...
pipeline {
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/D21IT185BapodraRajSatish/dummy.git'
            }
        }
//         stage('init'){
//             steps{
        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t d21it185rajbapodra/cldcimage:${IMAGE_NAME} ."    
                    }
            }
        }
         ...
         input{
            ...
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                    ...
                    sh "docker push d21it185rajbapodra/cldcimage:${IMAGE_NAME}"
                }}
